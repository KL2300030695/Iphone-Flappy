/**
 * Anil Flappy Bird - Core Game Logic
 */
...
let frameCount = 0;
let score = 0;
let bestScore = localStorage.getItem('anilBestScore') || 0;
...
// Audio
const flapSound = new Audio('While flapping.mp3');
...
function gameOver() {
    ...
    if (score > bestScore) {
        bestScore = score;
        localStorage.setItem('anilBestScore', bestScore);
    }
...
function draw() {
    ...
    if (backgroundImage.complete) {
        ...
        ctx.drawImage(backgroundImage, x + bgX, y, drawWidth, drawHeight);
        ctx.drawImage(backgroundImage, x + bgX + drawWidth, y, drawWidth, drawHeight);
    } else {
